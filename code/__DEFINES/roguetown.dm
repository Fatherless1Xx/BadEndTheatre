...
#define ALL_CLERIC_PATRONS 		list(/datum/patron/friendship/friend, /datum/patron/pagan/edledhron, /datum/patron/pagan/tsaiya, /datum/patron/pagan/zhakral)
#define ALL_PALADIN_PATRONS 	list(/datum/patron/friendship/friend, /datum/patron/pagan/edledhron, /datum/patron/pagan/tsaiya)
#define ALL_TEMPLAR_PATRONS 	list(/datum/patron/friendship/friend, /datum/patron/pagan/edledhron, /datum/patron/pagan/tsaiya)
