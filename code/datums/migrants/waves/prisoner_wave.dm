...
/datum/migrant_wave/prisoner_convoy
	...
	greet_text = "Nobody escape the rule of Vanderlin's barons. Some have fled to the neighbouring kingdom, Heartfelt and got caught, they are now on their way back."
